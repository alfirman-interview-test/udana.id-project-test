        ...
        <div className="bg-gray-50 text-xs text-gray-400 leading-relaxed">
          <div className="w-5/6 mx-auto py-10">
            <p>
              ...
              <br /> Penggunaan Udana diatur sesuai dengan Peraturan Otoritas
              Jasa Keuangan No. 37 Tahun 2018 Pasal 23 tentang Layanan Urun Dana
            ...
            <ol type="a" className="list-[lower-latin]">
              <li>
                “OTORITAS JASA KEUANGAN TIDAK MEMBERIKANPERNYATAAN MENYETUJUI
                ...
                PERNYATAAN YANG BERTENTANGAN DENGAN HAL TERSEBUT ADALAH
